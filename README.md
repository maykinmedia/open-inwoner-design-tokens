...
The draft [Design Token Format](https://design-tokens.github.io/community-group/format/) drives the structure of these design tokens. We are currently
using the updated W3C DTCG format (sets a Dollar sign in its specified properties, like `$type`,
